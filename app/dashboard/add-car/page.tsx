...
export default function AddCarPage() {
  ...
  const generateAiDescription = async () => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/api/ai/generate-description`, {
        method: "POST",
  ...
  const handleSubmit = async () => {
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/api/cars`, {
        method: "POST",
        headers: {
